        ...
        async signIn ({ user, account }) {
            if (account?.provider === "google" && user.email) {
                try {
                    ...
                    let existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patient.findUnique({
                        where: {
                            email: user.email
                        }
                    });
                    ...
                    if (!existingUser) {
                        ...
                        existingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].patient.create({
                            data: {
                                email: user.email,
                    ...
                    // Create session
                    const token = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSession"])(existingUser.id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0210ec3d._.js.map